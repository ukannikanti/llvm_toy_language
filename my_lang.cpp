...
// ability to process a text file and recognize what it says.
// The traditional way to do this is to use a “lexer” (aka ‘scanner’) to
// break the input up into “tokens”. Each token returned by the lexer includes
// a token code and potentially some metadata (e.g. the numeric value of a
// number). First, we define the possibilities:
...
// We use global variables for simplicity, but this is not the best choice for a
